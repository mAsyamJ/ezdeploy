...
interface ERC1155ContractDeployerProps {
  onBack?: () => void;
}
export default function ERC1155ContractDeployer({ onBack }: ERC1155ContractDeployerProps) {
  ...
  const [isBatchMintable, setIsBatchMintable] = useState(true);
  ...
  const resetForm = () => {
    ...
    // Reset ERC1155 features
    setIsMintable(true);
    setIsBatchMintable(true);
    setIsBurnable(false);
    setIsPausable(false);
        ...
        <div className='bg-white rounded-xl shadow-sm p-8'>
          <div className='flex justify-between items-center mb-4'>
            <h2 className='text-2xl font-bold text-black'>
              Configure ERC1155 Token Contract
            </h2>
            {onBack && (
              <button
                onClick={onBack}
          ...
          <div className='space-y-4'>
            {/* Basic Token Information */}
            <div className='mb-6'>
              <h3 className='text-lg font-semibold text-black mb-3'>Basic Token Information</h3>
              ...
              <div className='mb-4'>
                ...
                <input
                  ...
                  placeholder='My ERC1155 Collection'
                  required
                />
              </div>
            ...
            {/* Token Features */}
            <div className='mb-6'>
              <h3 className='text-lg font-semibold text-black mb-3'>Token Features</h3>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex items-center'>
                  <input
                    type='checkbox'
                    id='batchMintable'
                    checked={isBatchMintable}
                    onChange={(e) => setIsBatchMintable(e.target.checked)}
                    className='mr-2'
                  />
                ...
                <div className='flex items-center'>
                  ...
                  <label htmlFor='burnable' className='text-black'>
                    Burnable - Allow token holders to burn (destroy) their tokens
                  </label>
                </div>
                ...
                <div className='flex items-center'>
                  ...
                  <label htmlFor='updatableURI' className='text-black'>
                    Updatable Token URIs - Allow changing token metadata after minting
                  </label>
                </div>
                ...
                <div className='flex items-center'>
                  ...
                  <label htmlFor='supplyTracking' className='text-black'>
                    Supply Tracking - Keep count of all minted tokens per ID
                  </label>
                </div>
            ...
            >
              {isDeploying ? <>Deploying...</> : 'Deploy ERC1155 Contract'}
            </button>
          </div>
        </div>
      )}
